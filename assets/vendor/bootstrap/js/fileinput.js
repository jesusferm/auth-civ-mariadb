...
(function (factory) {
		...
		_initTemplateDefaults: function () {
			...
			self.defaults = {
				...
				fileActionSettings: {
					...
					indicatorErrorTitle: 'Error en la subida..',
	...
	$.fn.fileinputLocales.en = {
		...
		msgFileRequired: 'Selecciona al menos un archivo.',
		msgSizeTooSmall: 'Archivo "{name}" (<b>{size} KB</b>) es muy pequeño, debe ser más grande <b>{minSize} KB</b>.',
		msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño máximo permitido de carga de <b>{maxSize} KB</b>.',
		msgFilesTooLess: 'Seleccionar al menos <b>{n}</b> {files} para subir.',
		msgFilesTooMany: 'Número de archivos seleccionados <b>({n})</b> excede el máximo permitido <b>{m}</b>.',
		msgFileNotFound: 'Archivo "{name}" no encontrado!',
		msgFileSecured: 'Archivo sin acceso de lectura "{name}".',
		msgFileNotReadable: 'Archivo "{name}" no es accesible.',
		msgFilePreviewAborted: 'Vista previa cancelada para "{name}".',
		msgFilePreviewError: 'Se produjo un error al leer el archivo "{name}".',
		msgInvalidFileName: 'Caracteres inválidos o no admitidos en el nombre del archivo "{name}".',
		msgInvalidFileType: 'Archivo no válido "{name}". Sólo archivos "{types}".',
		msgInvalidFileExtension: 'Extensión de archivo inválido "{name}". Solo extensiones "{extensions}".',
		msgFileTypes: {
			'image': 'image',
			'html': 'HTML',
			'text': 'text',
		...
		msgUploadAborted: 'Subida de archivo cancelado',
		msgUploadThreshold: 'Procesando...',
		msgUploadBegin: 'Inicializando...',
		msgUploadEnd: 'Hecho',
		msgUploadEmpty: 'No hay datos válidos disponibles para la carga.',
		msgUploadError: 'Error',
		msgValidationError: 'Error en la validación',
		...
		msgFoldersNotAllowed: 'Arrastrar & soltar solamente! {n} folder(s) soltados.',
		msgImageWidthSmall: 'Ancho del archivo de imagen "{name}" debe ser menor a {size} px.',
		msgImageHeightSmall: 'Alto de la imagen "{name}" debe ser menor a {size} px.',
		msgImageWidthLarge: 'Ancho de la imagen "{name}" no debe exceder {size} px.',
		msgImageHeightLarge: 'Altura del archivo de imagen "{name}" no puede exceder {size} px.',
		msgImageResizeError: 'No se pudo conseguir que las dimensiones de la imagen cambien de tamaño.',
		msgImageResizeException: 'Error al redimensionar la imagen.<pre>{errors}</pre>',
		msgAjaxError: 'Algo salió mal en la {operation}. Por favor, inténtelo de nuevo más tarde!',
		msgAjaxProgressError: '{operation} falló',
		ajaxOperations: {
			deleteThumb: 'archivo eliminado',
			uploadThumb: 'archivo subido',
			uploadBatch: 'carga de archivos por lotes',
			uploadExtra: 'formulario de carga de datos'
		},
		dropZoneTitle: 'Arrastrar & soltar archivos aquí &hellip;',
		dropZoneClickTitle: '<br>(o haga clic para seleccionar {files})',
		previewZoomButtonTitles: {
			prev: 'Ver el archivo anterior',
			next: 'Ver el siguiente archivo',
			toggleheader: 'Cambiar la cabecera',
			fullscreen: 'Cambiar a pantalla completa',
			borderless: 'Cambiar el modo sin bordes',
			close: 'Cerrar la vista previa detallada'
		}
	};
